...
さらに、各観点ごとに以下も付け加えてください。
- **どの部分を根拠にして評価したか（具体的なフレーズまたは要素）**

また、以下も付け加えてください。

- 総合評価（◎／○／△）
- 総合評価の理由（100字以内）
- 総合評価に基づく具体的な改善アドバイス（150字以内＋できれば簡単なサンプルトーク例を添えてください）
...
<tr><td>総合評価</td><td>○</td><td></td></tr>
<tr><td>総合評価の理由</td><td>商品内容は明確だが、将来展開の具体性が不足している。</td></tr>
<tr><td>改善アドバイス</td><td>購入後のサポート体制や成功事例を示すトークを加えましょう。<br>例：「この商品はご購入後も3年間無料保証がついておりますので、安心してご利用いただけます。」</td></tr>
</table>
